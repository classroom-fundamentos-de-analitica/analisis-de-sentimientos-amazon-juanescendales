...
def pregunta_01():
    ...
    df = pd.read_csv(
        "amazon_cells_labelled.tsv", sep="\t", header=None, names=["msg", "lbl"]
    )
...
def pregunta_02():
    ...
    x_train, x_test, y_train, y_test = train_test_split(
        x_tagged, y_tagged, test_size=0.1, random_state=12345
    )
...
def pregunta_04():
    ...
    param_grid = {"BernoulliNB__alpha": np.linspace(0.1, 1, 10)}
